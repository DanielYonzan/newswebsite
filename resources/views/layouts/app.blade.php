    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseThree" class="collapse">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Advertisement Management</h6>
                    <a class="collapse-item" href="{{route('advertisement.create')}}">Create Advertisement</a>
                    <a class="collapse-item" href="{{route('advertisement.index')}}">List Advertisement</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseFour" class="collapse">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('comment.create')}}">Create Comment</a>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy;Daniel Yonzan</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
